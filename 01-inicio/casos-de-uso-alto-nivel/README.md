...
![Casos de Uso Alto Nivel](./diagramas/cu-alto-nivel.png)
*Figura 2: Principales interacciones de los actores con el sistema. 📌 Sube el diagrama correspondiente del PDF a esta carpeta como `cu-alto-nivel.png`*
