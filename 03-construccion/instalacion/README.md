...
<sub>📍 Estás en: <b>Instalación</b></sub>
...
Esta guía detalla los pasos necesarios para desplegar el sistema Maflow RPA en un entorno de servidor Windows.

## Requisitos Previos
- **SO:** Windows Server 2019 o superior.
- **Entorno:** Node.js v18+, SAP GUI 7.70+.
- **Herramientas:** UiPath Robot (Community o Enterprise).
- **BD:** Microsoft SQL Server con acceso a la instancia del MES.

## Pasos de Instalación

1.  **Base de Datos:**
    - Ejecutar los scripts de creación de tablas en la instancia SQL Server.
    - Configurar los permisos de acceso para el usuario del backend.

2.  **Servidor Backend:**
    - Clonar el repositorio.
    - Ejecutar `npm install`.
    - Configurar el archivo `.env` con las credenciales de BD y la URL de disparo del robot.
    - Iniciar con `npm start`.

3.  **Configuración RPA:**
    - Publicar el paquete `.nupkg` desde UiPath Studio al Robot local.
    - Configurar los selectores de SAP GUI según la resolución del servidor.

4.  **Frontend:**
    - Desplegar la build de React en el servidor web (Nginx o similar).

## Verificación
Ejecutar la prueba de humo: Iniciar sesión -> Guardar un registro de prueba -> Enviar a SAP. Si el robot se despierta y abre SAP, la instalación es correcta.
