...
<sub>📍 Estás en: <b>02 · Elaboración</b></sub>
...
En la fase de Elaboración se define la arquitectura base del sistema, se detallan los requisitos funcionales y no funcionales, y se modelan los comportamientos dinámicos mediante diagramas de estado.

## 🔬 Contenido de esta fase

En esta sección se detallan los siguientes artefactos:

1.  **[🏗️ Arquitectura del Sistema](./arquitectura/README.md)**: Definición de las 4 capas y el patrón MVC.
2.  **[🔄 Diagramas de Estado](./diagramas-estado/README.md)**: Modelado del ciclo de vida del robot, la Galia y la contraseña SAP.
3.  **[📝 Casos de Uso Detallados](./casos-de-uso-detallados/README.md)**: Especificación de los 17 casos de uso identificados.
4.  **[⚖️ Priorización de CU](./priorizacion-cu/README.md)**: Análisis de valor y riesgo para el desarrollo.
5.  **[📋 Requisitos RF/RNF](./requisitos/README.md)**: Listado detallado de requisitos de rendimiento, seguridad y plataforma.

## 🎯 Objetivos Alcanzados

- [x] Arquitectura de 4 capas validada para el entorno sin APIs de SAP.
- [x] Definición de los 17 casos de uso con sus respectivos actores.
- [x] Especificación de 15 Requisitos No Funcionales críticos.
- [x] Modelado de estados para el cambio automático de contraseña (cada 28 días).
