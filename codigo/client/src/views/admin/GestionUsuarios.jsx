    ...
    <div className="space-y-6 animate-fade-in max-w-7xl mx-auto pt-6 pb-12">
      ...
      {notification && (
        ...
        >
          {notification.type === 'error' ? (
            <AlertCircle className="w-5 h-5 text-red-500 dark:text-red-400 mr-3 shrink-0" />
          ) : (
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-slate-500 dark:text-slate-400 text-sm mt-1">Administra las cuentas de usuario de Maflow, sus perfiles asignados y estados de acceso.</p>
        </div>
                    ...
                    <tr key={u.id} className="hover:bg-slate-50/70 dark:hover:bg-slate-700/50 transition-all duration-150">
                      ...
                      <td className="py-4 px-6 whitespace-nowrap">
                        <div className="flex items-center space-x-3">
                          ...
                          <span className="text-slate-900 dark:text-slate-200 font-bold">{u.mail}</span>
                        </div>
                      </td>
                      ...
                      <td className="py-4 px-6 whitespace-nowrap text-center">
                        {u.estado ? (
                          ...
                          <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-bold bg-red-50 dark:bg-red-900/30 text-red-700 dark:text-red-400 border border-red-100 dark:border-red-800">
                      ...
                      <td className="py-4 px-6 whitespace-nowrap text-right">
                        <div className="flex items-center justify-end space-x-2">
                          <button
                            ...
                            className="px-3 py-1 bg-amber-50 dark:bg-amber-900/20 hover:bg-amber-100 dark:hover:bg-amber-900/40 text-amber-700 dark:text-amber-400 border border-amber-200/50 dark:border-amber-800/50 rounded-lg text-xs font-bold transition-colors"
                          >
                            Editar
                          </button>
                          <button
                            onClick={() => handleDelete(u.id, u.mail)}
                            className="px-3 py-1 bg-red-50 dark:bg-red-900/20 hover:bg-red-100 dark:hover:bg-red-900/40 text-red-600 dark:text-red-400 border border-red-200/50 dark:border-red-800/50 rounded-lg text-xs font-bold transition-colors"
                          >
                            Eliminar
                          </button>
                        </div>
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4">
              <div>
                ...
                <input
                  ...
                  className="block w-full px-4 py-2.5 bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-600 transition dark:text-white dark:placeholder-slate-500"
                />
              </div>

              <div>
                <label className="block text-xs font-bold uppercase tracking-wider text-slate-600 dark:text-slate-300 mb-1.5">
                  Contraseña {editingId && <span className="text-slate-400 dark:text-slate-500 normal-case font-normal">(Dejar en blanco para mantener la actual)</span>}
                </label>
                <input
                  type="password"
                  name="password"
              ...
              <div className="flex items-center space-x-3 pt-2">
                <input 
                  ...
                  onChange={handleFormChange}
                  className="w-4 h-4 text-blue-600 bg-slate-100 dark:bg-slate-900 border-slate-300 dark:border-slate-600 rounded focus:ring-blue-500"
                />
                <label htmlFor="estado" className="text-sm font-bold text-slate-700 dark:text-slate-300 cursor-pointer">
                  Usuario Activo
                </label>
              </div>
